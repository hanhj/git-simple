...
package/%.xdc.inc package/%_xconfig_Dsp1.c package/%.defs.h: %.xdc $(PKGCFGS)
	@$(MSG) generating interfaces for package xconfig_Dsp1" (because $@ is older than $(firstword $?))" ...
	$(XSRUN) -f xdc/services/intern/cmd/build.xs $(MK_IDLOPTS) -m package/package.xdc.dep -i package/package.xdc.inc package.xdc

.dlls,e674 .dlls: Dsp1.pe674

-include package/cfg/Dsp1_pe674.mak
-include package/cfg/Dsp1_pe674.cfg.mak
ifeq (,$(MK_NOGENDEPS))
-include package/cfg/Dsp1_pe674.dep
endif
Dsp1.pe674: package/cfg/Dsp1_pe674.xdl
	@


ifeq (,$(wildcard .libraries,e674))
Dsp1.pe674 package/cfg/Dsp1_pe674.c: .libraries,e674
endif

package/cfg/Dsp1_pe674.c package/cfg/Dsp1_pe674.h package/cfg/Dsp1_pe674.xdl: override _PROG_NAME := Dsp1.xe674
package/cfg/Dsp1_pe674.c: package/cfg/Dsp1_pe674.cfg

clean:: clean,e674
	-$(RM) package/cfg/Dsp1_pe674.cfg
	-$(RM) package/cfg/Dsp1_pe674.dep
	-$(RM) package/cfg/Dsp1_pe674.c
	-$(RM) package/cfg/Dsp1_pe674.xdc.inc

clean,e674::
	-$(RM) Dsp1.pe674
.executables,e674 .executables: Dsp1.xe674

Dsp1.xe674: |Dsp1.pe674

-include package/cfg/Dsp1.xe674.mak
Dsp1.xe674: package/cfg/Dsp1_pe674.oe674 
	$(RM) $@
	@$(MSG) lnke674 $@ ...
	$(RM) $(XDCCFGDIR)/$@.map
	$(ti.targets.elf.C674.rootDir)/bin/lnk6x -w -q -u _c_int00 -fs $(XDCCFGDIR)$(dir $@).  -q -o $@ package/cfg/Dsp1_pe674.oe674   package/cfg/Dsp1_pe674.xdl --abi=eabi -c -m $(XDCCFGDIR)/$@.map -l $(ti.targets.elf.C674.rootDir)/lib/rts6740_elf.lib
	
Dsp1.xe674: export C_DIR=
Dsp1.xe674: PATH:=$(ti.targets.elf.C674.rootDir)/bin/;$(PATH)
Dsp1.xe674: Path:=$(ti.targets.elf.C674.rootDir)/bin/;$(PATH)

Dsp1.test test,e674 test: Dsp1.xe674.test

Dsp1.xe674.test:: Dsp1.xe674
ifeq (,$(_TESTLEVEL))
	@$(MAKE) -R -r --no-print-directory -f $(XDCROOT)/packages/xdc/bld/xdc.mak _TESTLEVEL=1 Dsp1.xe674.test
else
	@$(MSG) running $<  ...
	$(call EXEC.Dsp1.xe674, ) 
endif
...
clean,e674::
	-$(RM) Dsp1.xe674
clean:: 
	-$(RM) package/cfg/Dsp1_pe674.pjt
%,copy:
	@$(if $<,,$(MSG) don\'t know how to build $*; exit 1)
	@$(MSG) cp $< $@
	$(RM) $@
	$(CP) $< $@
Dsp1_pe674.oe674,copy : package/cfg/Dsp1_pe674.oe674
Dsp1_pe674.se674,copy : package/cfg/Dsp1_pe674.se674

$(XDCCFGDIR)%.c $(XDCCFGDIR)%.h $(XDCCFGDIR)%.xdl: $(XDCCFGDIR)%.cfg .interfaces $(XDCROOT)/packages/xdc/cfg/Main.xs
	@$(MSG) "configuring $(_PROG_NAME) from $< ..."
	$(CONFIG) $(_PROG_XSOPTS) xdc.cfg $(_PROG_NAME) $(XDCCFGDIR)$*.cfg $(XDCCFGDIR)$*

.PHONY: release,xconfig_Dsp1
xconfig_Dsp1.tar: package/package.bld.xml
xconfig_Dsp1.tar: package/package.ext.xml
xconfig_Dsp1.tar: package/package.rel.dot
xconfig_Dsp1.tar: package/build.cfg
xconfig_Dsp1.tar: package/package.xdc.inc
ifeq (,$(MK_NOGENDEPS))
-include package/rel/xconfig_Dsp1.tar.dep
endif
package/rel/xconfig_Dsp1/xconfig_Dsp1/package/package.rel.xml:

xconfig_Dsp1.tar: package/rel/xconfig_Dsp1.xdc.inc package/rel/xconfig_Dsp1/xconfig_Dsp1/package/package.rel.xml
	@$(MSG) making release file $@ "(because of $(firstword $?))" ...
	-$(RM) $@
	$(call MKRELTAR,package/rel/xconfig_Dsp1.xdc.inc,package/rel/xconfig_Dsp1.tar.dep)


release release,xconfig_Dsp1: all xconfig_Dsp1.tar
clean:: .clean
	-$(RM) xconfig_Dsp1.tar
	-$(RM) package/rel/xconfig_Dsp1.xdc.inc
	-$(RM) package/rel/xconfig_Dsp1.tar.dep
