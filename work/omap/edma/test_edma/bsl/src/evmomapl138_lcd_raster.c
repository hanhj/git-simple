...
#define PINMUX_LCD_PWR_0_REG        (16)
#define PINMUX_LCD_PWR_0_MASK       (0x000000F0)
#define PINMUX_LCD_PWR_0_VALUE      (0x00000080)


#define LCD_PWR_GPIO_BANK              (6)      //BETA (2) Alpha (8)
#define LCD_PWR_GPIO_PIN               (5)     //BETA (8) Alpha (10)
