...
该系统以居民健康数据为中心,以居民健康服务和政府疫情监控为目标导向,将居民、社区、政府有机结合在一起.对于居民而言,通过此系统可以方便挂号，双向转诊,查询个人健康信息.对社区而言,可以及时了解社区居民健康状况,当发现异常时,可及时上报,并进行处理.对政府职能部门而言,通过此系统可以进行大数据分析,发现疾病规律,进行流行病学分析,在疫情发生时,可有效进行疫情管控.
建立高效,专业的区域信息系统平台.
