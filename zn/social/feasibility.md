...
- 健康数据采集  
	实现居民健康数据的自动采集,以获得健康和疫情监控的全部数据,尤其是对疫情防控执行提供技术保障.
- 健康诊疗：  
	居民在社区医院的就医信息纳入到信息系统中,为建立统一的医疗信息化平台提供数据.
- 异常报警：  
	实时对健康数据进行监控,当发现异常数据时能够及时发出报警信息,提示管理人员进行分析研判.
- 健康数据分析：  
	系统可对采集的数据通过人工智能进行综合分析,发现其中的规律信息,为政府职能部门分析提供了工具.
- 疫情发布：  
	在疫情发生期间,系统可以为网上发布,短信平台,终端信息提示,app信息推送等方式及时发布权威,准确信息提供技术条件.
- 数据查询：  
