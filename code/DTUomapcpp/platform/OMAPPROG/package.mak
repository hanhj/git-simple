...
package/%.xdc.inc package/%_OMAPPROG.c package/%.defs.h: %.xdc $(PKGCFGS)
	@$(MSG) generating interfaces for package OMAPPROG" (because $@ is older than $(firstword $?))" ...
...
package/rel/undefinedOMAPPROGpackage/package.rel.xml: package/package.cfg.xdc.inc
package/package.cfg.xdc.inc: $(XDCROOT)/packages/xdc/cfg/cfginc.js package.xdc
	@$(MSG) generating schema include file list ...
	$(CONFIG) -f $(XDCROOT)/packages/xdc/cfg/cfginc.js OMAPPROG $@
...
.PHONY: release,OMAPPROG
OMAPPROG.zip: package/package.bld.xml
OMAPPROG.zip: package/build.cfg
OMAPPROG.zip: package/package.xdc.inc
OMAPPROG.zip: package/package.cfg.xdc.inc
ifeq (,$(MK_NOGENDEPS))
-include package/rel/OMAPPROG.zip.dep
endif
package/rel/OMAPPROG/OMAPPROG/package/package.rel.xml: .force
	@$(MSG) generating external release references $@ ...
	$(XS) $(JSENV) -f $(XDCROOT)/packages/xdc/bld/rel.js $(MK_RELOPTS) . $@

OMAPPROG.zip: package/rel/OMAPPROG.xdc.inc package/rel/OMAPPROG/OMAPPROG/package/package.rel.xml
	@$(MSG) making release file $@ "(because of $(firstword $?))" ...
	-$(RM) $@
	$(call MKRELZIP,package/rel/OMAPPROG.xdc.inc,package/rel/OMAPPROG.zip.dep)


release release,OMAPPROG: all OMAPPROG.zip
clean:: .clean
	-$(RM) OMAPPROG.zip
	-$(RM) package/rel/OMAPPROG.xdc.inc
	-$(RM) package/rel/OMAPPROG.zip.dep
