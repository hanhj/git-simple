...
UserData user_data;
#pragma DATA_SECTION("DATAINSHARERAM")
DATA_BUF DataBuf;
#define MK_DSTB(ID) 0x##ID, sizeof(DataBuf.d_##ID.Data),&DataBuf.d_##ID,0x##ID,1,1,1
#pragma DATA_SECTION("DATAINSHARERAM")
...
{
//DataPosInTab 参数带入未作溢出处理 使用时请注意！
	switch (DataType)
	{
	case YXTAB:
