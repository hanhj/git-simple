...
\begin{array}{|l|}
\hline
\int sin^2 x=\frac{x}{2}-\frac{sin2x}{4} \\
\\
\int cos^2 x=\frac{x}{2}+\frac{sin2x}{4}\\
\\
\int cos^m x sin^n x=\frac{1}{m+n}cos^{m-1} x sin^{n+1}x +\frac{m-1}{m+n}\int cos^{m-2}x sin^{n}x
\\
\hline
\end{array}
\end{equation}
