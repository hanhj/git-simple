...
　　该系统以居民健康数据为中心，以居民健康服务和政府疫情监控为目标,将居民、社区、政府有机结合在一起。系统为社区居民建立电子病历，通过可穿戴式或医疗设备采集居民基础健康信息（如血压，体温等），尤其对是"老、慢、非"高风险人群进行监控。居民可通过手机App及时了解个人健康状况，发现健康隐患。健康数据通过光纤或5G传输网络汇总到职能部门数据中心。对于社区，通过此系统可及时了解居民健康状况，当出现异常时可及时进行处理；对于政府职能部门，通过此系统可以进行大数据分析，发现疾病规律，进行流行病学分析，在疫情发生时，可有效进行疫情管控。在疫情发生情况下，可通过此平台及时发布权威准确信息，为政府落实政策提供有力抓手。  
　　同时，本系统也将与地区医疗系统、医保、新农合建立信息共享，居民在就诊时，上级医疗机构可全面了解患者平时健康状况．当居民在社区进行康复治疗时，社区医生也可了解患者在上级医疗机构的诊疗情况，从而为实现居民的双向转诊提供技术支撑。　　  
...
# 2 建设模式 
## 2.1 系统建设目标
　　本系统建设是为政府职能部门提供社区用户基础健康数据，推进医疗信息化建设，为分级诊疗,疫情防控提供数据支持，为居民健康服务提供技术基础。  
...
　　现有的医疗信息系统主要包括公立医院的HIS系统,居民医保,新农合系统.在社区层面的医疗信息系统的现状一般呈点状分布，未与公立医院信息系统联网[9 10 11 12]。本系统的创新点在于将居民，医院,社区,政府有机结合起来，形成信息共享平台，发挥信息整合优势；将居民健康与疫情监控结合起来，做到平战结合，为政府职能部门的管理提供了有力手段。  

## 2.2 主站建设模式
经过多年发展,医院的信息化建设已经达到较高的水平,但是对于农村乡镇医院,偏远地区,以及社区医疗机构,其信息化水平还较低.对居民的健康数据采集还相对空白.本系统对社区居民健康信息全采集,尤其是是"老慢非"重点人群信息采集,填补了医疗信息系统的一个空白.

### 2.3.1主站系统的建设
本系统将建成一个大型的居民基础健康信息平台,

### 2.3.2 与已有系统的集成
本系统是对现有医疗信息系统的补充,对于已经建设运行多年的医院HIS系统,EMR,PACS等系统,通过规范化信息接口实现信息共享,二者共同完成居民健康服务和政府管理职能.
描述主站的部署方式,与其他系统的关系
