...
//    ERR_INIT_FAIL - something happened during initialization.
//-----------------------------------------------------------------------------
uint32 EVMOMAPL138_initRAM(void)
{
   uint32 rtn = 0;
...
// \return  none.
//-----------------------------------------------------------------------------
void EVMOMAPL138_pinmuxConfig(uint32 in_reg, uint32 in_mask, uint32 in_val)
{
...
// \return  none.
//-----------------------------------------------------------------------------
void EVMOMAPL138_lpscTransition(psc_regs_t *psc, uint32 in_domain, uint8 in_module, uint8 in_next_state)
{
...
//-----------------------------------------------------------------------------
/*uint8 UTIL_isUIBoardAttached(void)
{
